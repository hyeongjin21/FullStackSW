...
const GoodsDetail = () => {
  ...
  const getGood = async () => {
    let url = `http://localhost:3000/goods_list/${id}`;
  ...
  return (
    <>
      {good === null ? (<span>로딩</span>) : (<div className="goods-detail-box">
        ...
        <div className="goods-detail-box-info">
          <div className="goods-detail-title">
            <div className="goods-icon">
              ...
              {good.new == true ? <em className="goods-new">new</em> :
                good.best == true ? <em className="goods-best">best</em> : ""}
            </div>
